	...
	<section class="calculator">
		<div class="calculator__container">
			...
			<div class="calculator__results">
				...
				<div class="calculator__submit" v-if="isLoading">
					<cc-button @click="submitCalc" v-if="isSending" disabled :class="{'calculator__submit_loading': isSending}"><img src="@/assets/images/button/loading.svg" alt="Loading"></cc-button>
					<cc-button @click="submitCalc" v-else >Оставить заявку</cc-button>
				</div>
				<div class="calculator__submit" v-else>
						<cc-button @click="submitCalc" :disabled='isSending' :class="{'calculator__submit_disabled': isSending}">Оставить заявку</cc-button>
				</div>
			</div>
		</div>
	</section>
